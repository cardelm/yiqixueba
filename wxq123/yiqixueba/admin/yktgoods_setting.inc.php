...
if(!submitcheck('submit')) {
	...
	showsetting(lang('plugin/yiqixueba','shop_table'),'setting[yiqixueba_'.$mokuai_info['mokuainame'].'_shop_table]',$mokuai_setting['yiqixueba_'.$mokuai_info['mokuainame'].'_shop_table'],'text','','',lang('plugin/yiqixueba','shop_table_comment'),'','',true);
	showsetting(lang('plugin/yiqixueba','shopid_field'),'setting[yiqixueba_'.$mokuai_info['mokuainame'].'_shopid_field]',$mokuai_setting['yiqixueba_'.$mokuai_info['mokuainame'].'_shopid_field'],'text','','',lang('plugin/yiqixueba','shopid_field_comment'),'','',true);
	showsubmit('submit');
	showtablefooter();
	showformfooter();
}else{
