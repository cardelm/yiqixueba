...
/**
*	一起学吧平台程序
*	文件名：base_base.inc.php  创建时间：2013-6-4 09:36  杨文
*
*/
...
$this_page = 'plugins&identifier=yiqixueba&pmod=admin&submod=base';
...
if(!submitcheck('submit')) {
	...
	showformheader($this_page.'&subac=baseedit','enctype');
