...
//得到subop
$subop = getgpc('subop');
$subops = array('list','groupedit','designmokuai','editmokuai','pageedit','adminedit','moduleedit','templateedit','pagelist','makemokuai','adminacedit');
	...
	if(!submitcheck('submit')) {
		...
		while($row = DB::fetch($query)) {
			...
			showtablerow('', array('class="td25"','class="td25"', 'class="td25"', 'class="td23"','class="td25"','class="td28"',''), array(
				...
				'',
				'',
				$row['upid'] == 0 ? lang('plugin/yiqixueba_server','top_mokuai') : DB::result_first("SELECT mokuaititle FROM ".DB::table('yiqixueba_server_mokuai_group')." WHERE groupid=".$row['upid']),
				'',
			...
			while($row1 = DB::fetch($query1)) {
				showtablerow('', array('class="td25"','class="td25"', 'class="td25"', 'class="td23"','class="td25"','class="td23"','class="td29"', 'class="td25"',''), array(
					...
					"<a href=\"".ADMINSCRIPT."?action=$this_page&subop=editmokuai&groupid=$row[groupid]&mokuaiid=$row1[mokuaiid]\" class=\"act\">".lang('plugin/yiqixueba_server','edit')."</a>&nbsp;&nbsp;<a href=\"".ADMINSCRIPT."?action=$this_page&subop=pagelist&groupid=$row[groupid]&mokuaiid=$row1[mokuaiid]\" class=\"act\">".lang('plugin/yiqixueba_server','page')."</a>&nbsp;&nbsp;<a href=\"".ADMINSCRIPT."?action=$this_page&subop=makemokuai&groupid=$row[groupid]&mokuaiid=$row1[mokuaiid]\" class=\"act\">".lang('plugin/yiqixueba_server','makemokuai')."</a>"
				));
			}
			showtagfooter('tbody');
			$kk++;
